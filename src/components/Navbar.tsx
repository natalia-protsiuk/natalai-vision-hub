      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between py-4">
          <a href="#" className="text-2xl font-bold tracking-tighter text-foreground">
            Natalai<span className="text-primary">.</span>
          </a>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a href="#services" className="text-sm font-medium subtle-underline">
              Services
            </a>
            <a href="#portfolio" className="text-sm font-medium subtle-underline">
              Portfolio
            </a>
